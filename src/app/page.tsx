...
export default function NotesPage() {
  ...
  return (
    <div className="relative">
      <div className={`max-w-5xl mx-auto p-4 transition duration-200 ${openNote ? 'blur-sm' : ''}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {notes.map((note) => (
            ...
            >
              ...
              <p className="text-sm mt-1 line-clamp-4 text-gray-700">{note.content}</p>
  ...
  >
    ...
    >
      <h2 className="text-2xl font-bold mb-4 break-words">{openNote.title}</h2>
